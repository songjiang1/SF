...
namespace sys.Bll.Repository.SqlSugar
{
    ...
    public interface ISugarRepository
    {
        ...
        /// <returns>实体</returns>
        List<T> QueryList<T>(Pagination query = null) where T : class, new();
        ...
        /// <param name="totalCount">总行数</param>
        /// <returns>实体</returns>
        List<T> QueryPageList<T>(Pagination query, out int totalCount) where T : class, new();
        ...
        /// <returns></returns>
        List<T> QueryPageList<T>(Pagination query, out int totalCount, Expression<Func<T, bool>> whereLambda = null) where T : class, new();
        ...
        /// <returns></returns> 
        T GetEnty<T>(T entity) where T : class, new();
        /// <summary>
        /// 查询实体
        /// </summary>
        ...
        /// <param name="Key"></param>
        /// <returns></returns>
        T GetEnty<T>(string Key) where T : class, new();
        /// <summary>
        /// 查询集合
        /// </summary>
        /// <typeparam name="T">泛型参数(集合成员的类型)</typeparam>
        ...
        DataTable QueryDataTablePageList<T>(Pagination query, out int totalCount) where T : class, new();
        ...
        /// <param name="query">过滤条件</param>
        /// <returns></returns>
        List<T> QueryMapper<T>(Action<T> mapperAction, Pagination query = null) where T : class, new();
