...
namespace sys.Bll.Repository.SqlSugar
{
    ...
    public class SugarRepository<T> : ISugarRepository<T> where T : class, new()
    {
        #region MyRegion初始化
        ...
        public SimpleClient<T> simpleClient { get { return new SimpleClient<T>(DbContext); } }//用来处理表的常用操作
        /// <summary>
        /// 初始化
        /// </summary>
        ...
        {
            DbContext = BaseDbContext.GetIntance();
        }

        public SugarRepository()
        {
            this.DbContext = BaseDbContext.Db;
        }
        #endregion


        #region 事务
        public ISugarRepository<T> BeginTrans()
        {
        ...
        /// <returns>操作影响的行数</returns>
        public int Add(Dictionary<string, object> keyValues) 
        {
            try
            {
        ...
        /// <param name="entitys">泛型集合</param> 
        /// <returns>返回bool</returns>
        public bool AddReturnBool(List<T> entitys) 
        {
            try
            {
        ...
        /// <returns>操作影响的行数</returns>
        public int Update(T entity, List<string> lstIgnoreColumns = null, bool isLock = true) 
        {
            try
            {
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int Update(List<T> entitys, List<string> lstIgnoreColumns = null, bool isLock = true) 
        {
            try
            {
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int Update(T entity, Expression<Func<T, bool>> where, List<string> lstIgnoreColumns = null, bool isLock = true) 
        {
            try
            {
                IUpdateable<T> up = DbContext.Updateable(entity);
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int Update(Expression<Func<T, T>> update, Expression<Func<T, bool>> where = null, bool isLock = true) 
        {
            try
            {
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int Update(Dictionary<string, object> keyValues, Expression<Func<T, bool>> where = null, bool isLock = true) 
        {
            try
            {
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int UpdateColumns (List<T> entitys, Expression<Func<T, object>> updateColumns, Expression<Func<T, object>> wherecolumns = null, bool isLock = true) 
        {
            try
            {
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int UpdateRowVer(T entity, List<string> lstIgnoreColumns = null, bool isLock = true) 
        {
            try
            {
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int UpdateRowVer (Expression<Func<T, T>> update, Dictionary<string, object> where, bool isLock = true) 
        {
            try
            {
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int DeleteByPrimary (List<object> primaryKeyValues, bool isLock = true) 
        {
            try
            {
                var result = isLock ?
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int Delete(T entity, bool isLock = true) 
        {
            try
            {
                var result = isLock ?
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int Delete (List<T> entity, bool isLock = true) 
        {
            try
            {
                var result = isLock ?
        ...
        /// <param name="isLock"> 是否加锁 </param> 
        /// <returns>操作影响的行数</returns>
        public int Delete  (Expression<Func<T, bool>> where, bool isLock = true) 
        {
            try
            {
                var result = isLock ?
        ...
        /// <returns>值</returns>
        public int DeleteIn (List<dynamic> inValues) 
        {
        ...
        /// <returns>值</returns>
        public TResult QuerySelect<T, TResult>(Expression<Func<T, TResult>> expression, Expression<Func<T, bool>> whereLambda = null) 
        {
        ...
        /// <param name="whereLambda">查询表达式</param> 
        /// <returns>值</returns>
        public List<TResult> QuerySelectList<T,TResult>(Expression<Func<T, TResult>> expression, Expression<Func<T, bool>> whereLambda = null) 
        {
        ...
        /// <param name="whereLambda">查询表达式</param> 
        /// <returns>值</returns>
        public T Query (Expression<Func<T, bool>> whereLambda = null) 
        {
        ...
        /// <returns>实体</returns>
        public List<T> QueryWhereList(Expression<Func<T, bool>> whereLambda = null) 
        {
            ISugarQueryable<T> up = DbContext.Queryable<T>().With(SqlWith.NoLock);
            if (whereLambda != null)
            {
        ...
        /// <returns>实体</returns>
        public List<T> QueryList (Pagination query = null) 
        {
            ISugarQueryable<T> up = DbContext.Queryable<T>().With(SqlWith.NoLock);
            if (query != null)
            {
        ...
        /// <returns>实体</returns>
        public List<T> QuerySqlList (string sql) 
        {
            return DbContext.SqlQueryable<T>(sql).ToList();
             ...
             /// <param name="totalCount">总行数</param>
             /// <returns>实体</returns>
        public List<T> QueryPageList(Pagination query, out int totalCount, Expression<Func<T, bool>> whereLambda = null)
        {
            if (query == null)
            {
        ...
        /// <param name="totalCount">总行数</param>
        /// <returns>实体</returns>
        public List<T> QueryPageList (Pagination query, out int totalCount) 
        {
            if (query == null)
            {
                throw new ArgumentNullException(nameof(query));
        ...
        /// <param name="inValues">数据集合</param>
        /// <returns>值</returns>
        public List<T> In (string inFieldName, List<dynamic> inValues) 
        {
        ...
        /// <returns>值</returns>
        public List<T> In (List<dynamic> values) 
        {
        ...
        /// <param name="whereLambda">查询表达式</param>  
        /// <returns>实体</returns>
        public DataTable QueryDataTable (Expression<Func<T, bool>> whereLambda = null) 
        {
            ISugarQueryable<T> up = DbContext.Queryable<T>().With(SqlWith.NoLock);
            if (whereLambda != null)
            {
        ...
        {
            return DbContext.EntityMaintenance.GetTableName<T>();
        }
        /// <summary>
        /// 查询实体
        /// </summary>
        ...
        /// <returns></returns>
        public T GetEnty(string Key)
        {
            return simpleClient.GetById(Key);
        }
        /// <summary>
        /// 返回实体
        /// </summary>
        ...
        /// <returns></returns>
        public  T GetEnty(T t)
        {
            return simpleClient.GetById(t);
        }
        /// <summary>
        /// 查询单个值
        /// </summary> 
        ...
        public DataTable QueryDataTablePageList (Pagination query, out int totalCount) 
        {
            if (query == null)
            {
                throw new ArgumentNullException(nameof(query));
        ...
        /// <param name="query">过滤条件</param>
        /// <returns></returns>
        public List<T> QueryMapper (Action<T> mapperAction, Pagination query = null) 
        {
        ...
        /// <param name="whereLambda">过滤条件</param>
        /// <returns></returns>
        public List<T> QueryMapper (Action<T> mapperAction, Expression<Func<T, bool>> whereLambda = null) 
        {
            ISugarQueryable<T> up = DbContext.Queryable<T>();
            if (whereLambda != null)
            {
        ...
        /// <param name="whereLambda">查询表达式</param> 
        /// <returns>值</returns>
        public List<T> GroupBy (Expression<Func<T, object>> groupByLambda, Expression<Func<T, bool>> whereLambda = null) 
        {
        ...
        /// <param name="whereLambda">查询表达式</param> 
        /// <returns>值</returns>
        public List<TResult> GroupBy<T, TResult>(Expression<Func<T, TResult>> expression, Expression<Func<T, object>> groupByLambda, Expression<Func<T, bool>> whereLambda = null) 
        {
        ...
        public string QueryJson (Expression<Func<T, bool>> whereLambda = null) 
        {
            ISugarQueryable<T> up = DbContext.Queryable<T>().With(SqlWith.NoLock);
            if (whereLambda != null)
            {
        ...
        /// <param name="field">字段</param> 
        /// <returns>值</returns>
        public TResult Max<T, TResult>(string field) 
        {
        ...
        /// <param name="field">字段</param> 
        /// <returns>值</returns>
        public TResult Min<T, TResult>(string field) 
        {
        ...
        /// <returns></returns>
        public string CustomNumber(string key, string prefix = "", int fixedLength = 4, string dateFomart = "") 
        {

            var listNumber = CustomNumber(key, 1, prefix, fixedLength, dateFomart);
            return listNumber[0];
        }
        /// <summary>
        /// 生成流水号
        ...
        /// <param name="num">数量</param>
        /// <returns></returns>
        public List<string> CustomNumber(string key, int num, string prefix = "", int fixedLength = 4, string dateFomart = "") 
        {
