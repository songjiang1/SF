...
namespace sys.Dal.Busines.AuthorizeManage
{
    /// <summary>
    /// 版 本
    /// Copyright (c)  
    ...
    public class AuthorizeBLL
    {
        ...
        public bool ActionAuthorize(string userId, string moduleId, string action)
        {
            ...
            if (action.IndexOf("Design") > -1 || action.IndexOf("TvBrowse") > -1 || action.IndexOf("ResourceFile") > -1 || action.IndexOf("RegistUser") > -1 )
            {
                return true;
            }
