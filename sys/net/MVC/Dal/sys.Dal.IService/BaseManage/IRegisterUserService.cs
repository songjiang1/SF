...
namespace sys.Dal.IService.BaseManage
{
    ...
    public interface IRegisterUserService
    {
        ...
        /// </summary>
        /// <returns></returns>
        DataTable GetInitials(RegisterUserEntity collection);
        /// <summary>
        /// 用户首字母
        /// </summary>
        /// <returns></returns>
        DataTable GetInitialsUser(RegisterUserEntity collection, string OrderBy);
        ...
        /// <returns></returns>
        void ImportRegistUser(List<RegisterUserEntity> userEntity);
        ...
        /// <returns></returns>
        int UpdateHeadIcon(string keyValue, string HeadIcon);
        /// <summary>
        /// 审核
        /// </summary>
        /// <param name="keyValue">主键值</param>
        ...
        void UpadteParentId(string keyValue, string parentId, string placeholder, string oldUserId="");
        ...
        void UpadteDescription(string keyValue, string description);
        #endregion
    }
}
