...
namespace sys.Util
{
    ...
    public sealed partial class Str
    {
        ...
        #region MyRegion PinYin(获取汉字的拼音 全拼)
        /// <summary>
        /// PinYin(获取汉字的拼音 全拼)
        /// </summary>
        /// <param name="chineseText"></param>
        /// <returns></returns>
        public static string GetPinYin(string chineseText,bool isEmpty=false)
        {
            return WordsHelper.GetPinYin(chineseText, isEmpty);
        }
        #endregion
