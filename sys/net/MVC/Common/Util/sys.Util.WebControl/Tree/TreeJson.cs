        ...
        public static string TreeToJson(this List<TreeEntity> list, string ParentId = "0")
        {
            ...
            if (item.Count > 0)
            {
                foreach (TreeEntity entity in item)
                {
                    ...
                    if (entity.AttributeB != null && !string.IsNullOrEmpty(entity.AttributeB))
                    {
                    ...
                    //if (entity.type != null && !string.IsNullOrEmpty(entity.type.Replace("&nbsp;", "")))
                    //{
                    //    strJson.Append("\"type\":\"" + entity.type.Replace("&nbsp;", "") + "\",");
                    //}
