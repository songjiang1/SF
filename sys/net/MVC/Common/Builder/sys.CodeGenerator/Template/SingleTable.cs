...
namespace sys.CodeGenerator.Template
{
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("namespace sys.Application.Entity." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using sys.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace sys.Application.Mapping." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// Copyright (c)  \r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using sys.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            ...
            sb.Append("namespace sys.Application.Service." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 2.0\r\n");
            sb.Append("    /// Copyright (c)  \r\n");
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace sys.Application.IService." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 2.0\r\n");
            sb.Append("    /// Copyright (c)  \r\n");
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("using sys.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Application.Service." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace sys.Application.Busines." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 2.0\r\n");
            sb.Append("    /// Copyright (c)  \r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using sys.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Application.Busines." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Util;\r\n");
            sb.Append("using sys.Util.WebControl;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace sys.Application.Web.Areas." + baseConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 2.0\r\n");
            sb.Append("    /// Copyright (c)  \r\n");
