...
namespace sys.CodeGenerator.Template
{
    /// <summary>
    /// 版 本 2.0
    /// Copyright (c)  
    ...
    public class MultiTable
    {
        ...
        public string EntityBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> gridColumnModel, bool isChildTable)
        {
            ...
            try
            {
                ...
                sb.Append("using sys.Application.Code;\r\n\r\n");


                sb.Append("namespace sys.Application.Entity." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
        ...
        public string EntityMapBuilder(MultiTableConfigModel multiTableConfigModel, bool isChildTable)
        {
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                sb.Append("using sys.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
                sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

                sb.Append("namespace sys.Application.Mapping." + multiTableConfigModel.OutputAreas + "\r\n");
                sb.Append("{\r\n");
                sb.Append("    /// <summary>\r\n");
                sb.Append("    /// 版 本\r\n");
                sb.Append("    /// Copyright (c)  \r\n");
        ...
        public string ServiceBuilder(MultiTableConfigModel multiTableConfigModel, List<GridColumnModel> colModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using sys.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Data.Repository;\r\n");
            sb.Append("using sys.Util.WebControl;\r\n");
            sb.Append("using System;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n");
            sb.Append("using sys.Util;\r\n");
            sb.Append("using sys.Util.Extension;\r\n\r\n");

            sb.Append("namespace sys.Application.Service." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 2.0\r\n");
            sb.Append("    /// Copyright (c)  \r\n");
        ...
        public string IServiceBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("namespace sys.Application.IService." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 2.0\r\n");
            sb.Append("    /// Copyright (c)  \r\n");
        ...
        public string BusinesBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            ...
            sb.Append("using sys.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Application.IService." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Application.Service." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace sys.Application.Busines." + multiTableConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 2.0\r\n");
            sb.Append("    /// Copyright (c)  \r\n");
        ...
        public string ControllerBuilder(MultiTableConfigModel multiTableConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using sys.Application.Entity." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Application.Busines." + multiTableConfigModel.OutputAreas + ";\r\n");
            sb.Append("using sys.Util;\r\n");
            sb.Append("using sys.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace sys.Application.Web.Areas." + multiTableConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 2.0\r\n");
            sb.Append("    /// Copyright (c)  \r\n");
